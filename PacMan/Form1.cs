...
namespace PacMan
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            get { return mScore; }
            set { mScore = value; LScore.Text = "Score : " + mScore; }
        }
        ...
        private void PbGrille_Click(object sender, EventArgs e)
        {

        }

        private void TTimer_Tick(object sender, System.EventArgs e)
        {
            if (Pause > 0) // En pause ?
            {
                Pause--;
        ...
        private void DetecterEtGererCollisionFantome(Fantome UnFantome)
        {
            if (DetecterCollisionFantome(UnFantome))
            {
                ...
                {
                    Pause = 30; // Temps pour jouer le son
                ...
                {
                    Pause = 20; // Temps pour jouer le son
